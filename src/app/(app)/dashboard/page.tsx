        ...
        <div className="w-[872px] h-[3312px] relative">
            ...
            <div className="w-[1252px] h-[3312px] relative">
                ...
                <div className="w-[1208.29px] h-[105.91px] left-[13px] top-[2940.68px] absolute">
                    <img className="w-[450.01px] h-[84.32px] left-[2.91px] top-[5.50px] absolute origin-top-left rotate-[2.06deg]" src="https://via.placeholder.com/450x84" />
                    <img className="w-[450.01px] h-[84.32px] left-[380.21px] top-[3.75px] absolute origin-top-left rotate-[2.06deg]" src="https://via.placeholder.com/450x84" />
                    <img className="w-[450.01px] h-[84.32px] left-[758.57px] top-0 absolute origin-top-left rotate-[2.06deg]" src="https://via.placeholder.com/450x84" />
                </div>
                <div className="h-[753px] pb-3.5 left-[152px] top-[2167px] absolute flex-col justify-start items-start inline-flex">
                    ...
                    <div className="w-[897px] h-[521px] relative">
                        ...
                        <img className="w-[300px] h-[430.71px] left-0 top-0 absolute" src="https://via.placeholder.com/300x431" />
                ...
                <div className="w-[1238px] h-[466px] left-[11px] top-[867px] absolute">
                    <div className="origin-top-left rotate-[1.93deg] w-[1233px] h-[156.27px] left-[5.25px] top-[259px] absolute">
                        <img className="w-[450px] h-[122.27px] left-[-1.14px] top-[33.98px] absolute origin-top-left rotate-[1.93deg]" src="https://via.placeholder.com/450x122" />
                        <img className="w-[450px] h-[122.27px] left-[387.18px] top-[31.02px] absolute origin-top-left rotate-[1.93deg]" src="https://via.placeholder.com/450x122" />
                        <img className="w-[450px] h-[122.27px] left-[782.56px] top-[26.30px] absolute origin-top-left rotate-[1.93deg]" src="https://via.placeholder.com/450x122" />
                    </div>
                    <div className="w-[811px] h-[444.71px] left-[227px] top-0 absolute">
                        <img className="w-[300px] h-[430.71px] left-[511px] top-[14px] absolute" src="https://via.placeholder.com/300x431" />
                ...
                <div className="w-[1249px] h-[219.72px] left-[-15px] top-[127px] absolute">
                    <div className="w-[1237px] h-[60.72px] left-0 top-[159px] absolute">
                        <img className="w-[450px] h-[60.72px] left-0 top-0 absolute" src="https://via.placeholder.com/450x61" />
                        <img className="w-[450px] h-[60.72px] left-[787px] top-0 absolute" src="https://via.placeholder.com/450x61" />
                        <img className="w-[450px] h-[60.72px] left-[393px] top-0 absolute" src="https://via.placeholder.com/450x61" />
                    </div>
